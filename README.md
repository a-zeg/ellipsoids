...
> [!CAUTION]
> 
> This is an old version of the code. For the latest version, see the [`main`](https://github.com/a-zeg/ellipsoids/tree/main) branch — it should be clearer and easier to use. 
